...
public class JTabbedpane1 extends JFrame implements ActionListener{
	...
	public JTabbedpane1() throws ClassNotFoundException, SQLException  {
		...
		JScrollPane scro = new JScrollPane(txtb, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		...
		final JButton bto2 = new JButton("刷新");
		final JButton bto3 = new JButton("按公司名称检索");
		final JTextField txtj = new JTextField();
		panel2.setLayout(null);
		txtj.setBounds(500, 20, 100, 30);
		bto1.setBounds(50, 20, 60, 30);
		bto1.setBounds(200, 20, 60, 30);
