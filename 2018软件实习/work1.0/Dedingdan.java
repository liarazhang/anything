...
import javax.swing.*;
public class Dedingdan extends JFrame
{
		public Dedingdan() 
		{
			setTitle("删除销售单");
			...
			setLayout(null); 
			//
			JLabel dingdan_id = new JLabel("请输入要删除的销售单的编号:"); 
	        add(dingdan_id);
			...
			jb1.addActionListener(new ActionListener()
	        {
	        	...
	        	{
	    			JOptionPane.showMessageDialog(null, "删除销售单成功！", " ",2 );
	        	}
	        }
	        );
			//返回按钮功能
