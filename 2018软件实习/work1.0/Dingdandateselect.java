...
import javax.swing.*;
public class Dingdandateselect extends JFrame
{
	public Dingdandateselect() 
	{
		setTitle("查询销售单");
    	setSize(550, 350);
    	setResizable(false);
		setLayout(null); 
		//
		JLabel input = new JLabel("请输入要查询的销售单的订购日期:"); 
        add(input);
        input.setFont(new Font("宋体", Font.BOLD, 12));
        input.setBounds(100, 18, 210, 20);
    ...
    {
        new Dingdandateselect().background();
    }
}
